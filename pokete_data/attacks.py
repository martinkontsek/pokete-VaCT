attacks = {
    ...
    "steel_slap": {
        ...
        "miss_chance": 0,
        "min_lvl": 0,
        "desc": "Slaps the enemy with the tail.",
        "types": ["normal", "cyborg"],
        "effect": None,
        "is_generic": False,
        "ap": 15,
    ...
    "fake_uid": {
        ...
        "miss_chance": 0.3,
        "min_lvl": 10,
        "desc": "Fools the enemy and causes confusion.",
        "types": ["normal", "cyborg"],
        "effect": "confusion",
        "is_generic": False,
        "ap": 10,
    ...
    "magspoof": {
        ...
        "miss_chance": 0.5,
        "min_lvl": 15,
        "desc": "Spoofs the enemy's credit card causing financial loss, making them burn with rage.",
        "types": ["normal", "cyborg"],
        "effect": "burning",
        "is_generic": False,
        "ap": 3,
    ...
    "rf_spoof": {
        ...
        "miss_chance": 0.1,
        "min_lvl": 0,
        "desc": "Spoofs RF signals which paralyze the enemy.",
        "types": ["normal", "cyborg"],
        "effect": "paralyzation",
        "is_generic": False,
        "ap": 20,
    ...
    "relay_attack": {
        ...
        "miss_chance": 0,
        "min_lvl": 5,
        "desc": "Performs relay attack on enemy's authentication devices causing them to freeze up with terror.",
        "types": ["normal", "cyborg"],
        "effect": "freezing",
        "is_generic": False,
        "ap": 20,
