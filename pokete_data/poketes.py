...
W         W""",
    ...
    "Pandamonium": {  # This is the Poketes simplified name/identifier without spaces and in lowercase, which is used to refer to the Pokete in the code
        "name": "Pandamonium",  # This is the Pokete's pretty name
        "hp": 35,  # The Pokete's max health points
        "atc": 1,  # The Pokete's attack points that will added to the Pokete's level
        "defense": 4,  # The Pokete's defense points that will added to the Pokete's level
        "attacks": ["tackle", "hiding", "mind_blow"],  # The Pokete's starting attacks
        ...
        "desc": "Just cute panda with stone skin.",  # The Pokete's description
