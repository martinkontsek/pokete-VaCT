  ...
  \    /
   \../
    ''""",
        ...
        "Kade": {  # This is the Poketes simplified name/identifier without spaces and in lowercase, which is used to refer to the Pokete in the code
        "name": "Kade",  # This is the Pokete's pretty name
